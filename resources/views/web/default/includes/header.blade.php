  ...
  <div id="main">
    <nav id="navbar">
      <ul id="links">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">Lease</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">Ride Share</a>
        </li>
        <li class="nav-item">
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav ">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="/register"><i class="fa fa-user-circle" aria-hidden="true"></i></a>
                  </li>
                  <li class="nav-item">
