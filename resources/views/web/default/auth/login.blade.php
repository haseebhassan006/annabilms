    ...
    <div class="container">
        ...
        <div class="row login-container">
            ...
            <div class="col-12 col-md-6 pl-0">
                <img src="{{ asset('frontend/assets/images/girl-student-pic.png') }}" class="img-cover" alt="Login">
            </div>
            <div class="col-12 col-md-6">
                <div class="login-card">
                    ...
                    <a href="/google" target="_blank" class="social-login mt-20 p-10 text-center  align-items-center justify-content-center">
                    ...
                    <a href="{{url('/facebook/redirect')}}" target="_blank" class="social-login mt-20 p-10 text-center  align-items-center justify-content-center ">
