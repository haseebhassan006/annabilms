                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="empty-state mx-auto d-block"  data-width="900" >
                                ...
                                <h5 class="lead">
                                You can get this plugin by <strong><a href="mailto:customersdemo@customersdemo.com">contacting support</a></strong> our checking <strong><a href="{{ url('/') }}">CRM</a></strong>  </h5>                              </p>
                              </div>
